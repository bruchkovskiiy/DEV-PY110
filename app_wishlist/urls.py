...
from .views import wishlist_view, wishlist_view_json, wishlist_add_view_json, wishlist_del_view_json, wishlist_remove_view  #  TODO Импортируйте ваше представление
